...
export class addProjectPlans1540062777613 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`INSERT INTO plan (code, name, maxStrings) VALUES ('club-factory', 'Club Factory', 10000000);`)
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`DELETE FROM plan WHERE code = 'club-factory';`)
